...
class DirectMessagesAll extends StatefulWidget {
  const DirectMessagesAll({Key key, this.analytics, this.observer}) : super(key: key);

  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;
  @override
  _DirectMessagesAllState createState() => _DirectMessagesAllState();
}

class _DirectMessagesAllState extends State<DirectMessagesAll> {
