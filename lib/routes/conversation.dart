        ...
        return Row(
          children: <Widget>[
            ...
            // Text
              ...
              width: 200.0,
              decoration: BoxDecoration(color: AppColors.secondary, borderRadius: BorderRadius.circular(8.0)),
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  document.get('type') == 0
                    ...
                    padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                    width: 200.0,
                    decoration: BoxDecoration(color: AppColors.primary, borderRadius: BorderRadius.circular(8.0)),
              ...
              isLastMessageLeft(index)
                ...
                child: Text(
                  ...
                  style: TextStyle(color: AppColors.secondary, fontSize: 12.0, fontStyle: FontStyle.italic),
                ),
  ...
  Widget buildSticker() {
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(border: Border(top: BorderSide(color: AppColors.secondary, width: 0.5)), color: Colors.white),
